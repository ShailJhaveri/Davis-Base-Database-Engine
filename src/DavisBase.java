        ...
        File f1=new File("Data");
                ...
                if(!f1.exists())
                {
                    ...
                    try
                    {
                        ...
                        RandomAccessFile table_det=new RandomAccessFile("Data\\catalog\\davisbase_tables.tbl","rw");
                        table_det.setLength(pageSize);
                        RandomAccessFile column_det=new RandomAccessFile("Data\\catalog\\davisbase_columns.tbl","rw");
                        column_det.setLength(pageSizec);
                        int l="davisbase_tables".length();
                        int c="davisbase_columns".length();

                        ps=ps-l-1;
                        table_det.seek(ps);
                        table_det.writeByte(1);
                        table_det.writeBytes("davisbase_tables");


                        ps=ps-c-1;
                        table_det.seek(ps); 
                        table_det.writeByte(2);
                        table_det.writeBytes("davisbase_columns");


                        table_det.seek(1);
                        table_det.writeByte(02);

                        table_det.seek(2);
                        table_det.writeShort(477);

                        table_det.seek(8);
                        table_det.writeShort(495);
                        ...
                        column_det.setLength(pageSizec);
                        column_det.seek(8);
                        column_det.writeShort((int) (pageSizec-34));
                        column_det.seek(pageSizec-34);

                        column_det.writeByte(1);
                        column_det.writeByte(1);

                        column_det.writeByte(16);
                        column_det.writeBytes("davisbase_tables");

                        column_det.writeByte(5);
                        column_det.writeBytes("rowid");

                        column_det.writeByte(3);
                        column_det.writeBytes("INT");

                        column_det.writeByte(1);
                        column_det.writeByte(1);

                        column_det.writeByte(2);
                        column_det.writeBytes("NO");
                        ...
                        column_det.seek(10);
                        column_det.writeShort((int) (pageSizec-40));
                        column_det.seek(pageSizec-40);
                        ...
                        column_det.writeByte(10);
                        column_det.writeBytes("table_name");

                        column_det.writeByte(4);
                        column_det.writeBytes("TEXT");
                        ...
                        column_det.seek(12);
                        column_det.writeShort((int) (pageSizec-35));
                        column_det.seek(pageSizec-35);

                        column_det.writeByte(1);
                        column_det.writeByte(3);

                        column_det.writeByte(17);
                        column_det.writeBytes("davisbase_columns");
                        ...
                        column_det.seek(14);
                        column_det.writeShort((int) (pageSizec-41));
                        column_det.seek(pageSizec-41);
                        ...
                        column_det.seek(16);
                        column_det.writeShort((int) (pageSizec-42));
                        column_det.seek(pageSizec-42);
                        ...
                        column_det.writeByte(11);
                        column_det.writeBytes("column_name");
                        ...
                        column_det.writeByte(1);
                        column_det.writeByte(6);

                        column_det.writeByte(17);
                        column_det.writeBytes("davisbase_columns");

                        column_det.writeByte(9);
                        column_det.writeBytes("data_type");
                        ...
                        pageSizec = pageSizec - 40;
                        column_det.seek(20);
                        column_det.writeShort((int) (pageSizec-50));
                        column_det.seek(pageSizec-50);

                        column_det.writeByte(1);
                        column_det.writeByte(7);

                        column_det.writeByte(17);
                        column_det.writeBytes("davisbase_columns");

                        column_det.writeByte(16);
                        column_det.writeBytes("ordinal_position");

                        column_det.writeByte(7);
                        column_det.writeBytes("TINYINT");
                        ...
                        column_det.writeByte(1);
                        column_det.writeByte(8);

                        column_det.writeByte(17);
                        column_det.writeBytes("davisbase_columns");

                        column_det.writeByte(11);
                        column_det.writeBytes("is_nullable");
                         ...
                         if(!e)
                             { 
                                 ...
                                 for(int i=0;i<datatype.length;i++){
                                    ...
                                    else if(temp1[1].equalsIgnoreCase("float"))
                                    {
                                        record_size=record_size+4;
                                        serialCode=0x08;
                                    }
